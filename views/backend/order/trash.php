            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-12 text-right">
                        <a href="index.php?option=order" class="btn btn-info btn-sm btn-undo">
                ...
                <table class="table table-bordered" id="myTable">
                    <thead>
                        <tr>
                            ...
                            <th>Điện thoại</th>
                            <th>Chức năng</th>
                            <th style="max-width:70px" >ID sản phẩm</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="index.php?option=order&cat=retrash&id=<?php echo $row['Id']; ?>" title="undo" class="btn btn-sm btn-info"> 
