  ...
  <div class="content-wrapper py-2">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="text-uppercase text-danger">THÊM MỚI TRANG ĐƠN</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="row mb-2">
            <div class="col-md-12 text-right">
              ...
              <a href="index.php?option=post" class="btn btn-sm btn-info">
                      <i class="fas fa-undo"></i>Quay về danh sách Trang Đơn
              </a>
          ...
          <div class="row">
              ...
              <input name ="id"  type="hidden" value ="<?=$row['Id'];?>"  id="id"  class ="form-control">
                  <div class="mb-3">
                      ...
                      <input name="data[Title]" value ="<?=$row['Title'];?>" type="text" id="name" placeholder="Nhập tên Trang Đơn" class="form-control">
                  </div>
                  <div class="mb-1">
                      <label for="metakey">Nội Dung Trang Đơn</label>
                      <textarea name="data[Detail]" id="metakey" rows="5" class="form-control"><?=$row['Detail'];?></textarea>
                  </div>
                  <div class="mb-1">
              ...
              <div class="col-md-3">
                <div class="mb-3">
                    <label for="topid">Chủ Đề Trang Đơn</label>
                ...
                <div class="mb-3">
                    <label for="type">Loại Trang Đơn</label>
                    <input name="data[Type]" value ="<?=$row['Type'];?>" type="text" id="name" placeholder="<?=$strtypeid?>" class="form-control">
                </div>
                <div class="mb-3"> 
                    <label for="img">Hình</label> 
                    <input type="file" value ="<?=$row['Img'];?>" class="form-control" id="img" name="img">
                  </div>
                <div class="mb-3">
