...
class Router
{
    ...
    //Tùy Biến URL người dùng
function router_site()
{
...
//Tùy Biến URL quản lý
function router_admin()
{
...
function error404()
    ...
    <a class='btn' href='index.php'>Trở về Trang Chính</a>
    </div>
